...
F = new Array();
F[0] = new Array();
F[0][0]='"house" as Direct Object';
F[0][1] = 1;
F[1] = new Array();
F[1][0]='"doctor" as Subject';
F[1][1] = 2;
F[2] = new Array();
F[2][0]='" teachers" as Direct Object';
F[2][1] = 3;
F[3] = new Array();
F[3][0]='"toil" as Subject';
F[3][1] = 4;
F[4] = new Array();
F[4][0]='" teacher" as Subject';
F[4][1] = 5;
F[5] = new Array();
F[5][0]='"doctor" as Direct Object';
F[5][1] = 6;
F[6] = new Array();
F[6][0]='"doctors" as Direct Object';
F[6][1] = 7;


D = new Array();
D[0] = new Array();
D[0][0]='<img src="oikov.jpg" alt="oikov.jpg" width="220" height="30" border="0"></img>';
D[0][1] = 1;
D[0][2] = 0;
D[1] = new Array();
D[1][0]='<img src="iatros.jpg" alt="iatros.jpg" width="220" height="30" border="0"></img>';
D[1][1] = 2;
D[1][2] = 0;
D[2] = new Array();
D[2][0]='<img src="didaskalous.jpg" alt="didaskalous.jpg" width="220" height="30" border="0"></img>';
D[2][1] = 3;
D[2][2] = 0;
D[3] = new Array();
D[3][0]='<img src="povos.jpg" alt="povos.jpg" width="220" height="30" border="0"></img>';
D[3][1] = 4;
D[3][2] = 0;
D[4] = new Array();
D[4][0]='<img src="didaskalos.jpg" alt="didaskalos.jpg" width="220" height="30" border="0"></img>';
D[4][1] = 5;
D[4][2] = 0;
D[5] = new Array();
D[5][0]='<img src="iatrov.jpg" alt="iatrov.jpg" width="220" height="30" border="0"></img>';
D[5][1] = 6;
D[5][2] = 0;
D[6] = new Array();
D[6][0]='<img src="iatrous.jpg" alt="iatrous.jpg" width="220" height="30" border="0"></img>';
D[6][1] = 7;
D[6][2] = 0;
