...
F = new Array();
F[0] = new Array();
F[0][0]='<img src="hn thaumastn.gif" alt="hn thaumastn.gif" width="180" height="30" border="0"></img>';
F[0][1] = 1;
F[1] = new Array();
F[1][0]='<img src="tnv neav.gif" alt="tnv neav.gif" width="180" height="30" border="0"></img>';
F[1][1] = 2;
F[2] = new Array();
F[2][0]='<img src="tais veais.gif" alt="tais veais.gif" width="180" height="30" border="0"></img>';
F[2][1] = 3;
F[3] = new Array();
F[3][0]='<img src="tns thaumastns.gif" alt="tns thaumastns.gif" width="180" height="30" border="0"></img>';
F[3][1] = 4;
F[4] = new Array();
F[4][0]='<img src="tni veai.gif" alt="tni veai.gif" width="180" height="30" border="0"></img>';
F[4][1] = 5;
F[5] = new Array();
F[5][0]='<img src="twv thaumastwv.gif" alt="twv thaumastwv.gif" width="180" height="30" border="0"></img>';
F[5][1] = 6;


D = new Array();
D[0] = new Array();
D[0][0]='<img src="techvn.gif" alt="techvn.gif" width="180" height="30" border="0"></img>';
D[0][1] = 1;
D[0][2] = 0;
D[1] = new Array();
D[1][0]='<img src="hemerav.gif" alt="hemerav.gif" width="180" height="30" border="0"></img>';
D[1][1] = 2;
D[1][2] = 0;
D[2] = new Array();
D[2][0]='<img src="hemerais.gif" alt="hemerais.gif" width="180" height="30" border="0"></img>';
D[2][1] = 3;
D[2][2] = 0;
D[3] = new Array();
D[3][0]='<img src="techvns.gif" alt="techvns.gif" width="180" height="30" border="0"></img>';
D[3][1] = 4;
D[3][2] = 0;
D[4] = new Array();
D[4][0]='<img src="hemerai.gif" alt="hemerai.gif" width="180" height="30" border="0"></img>';
D[4][1] = 5;
D[4][2] = 0;
D[5] = new Array();
D[5][0]='<img src="techvwv.gif" alt="techvwv.gif" width="180" height="30" border="0"></img>';
D[5][1] = 6;
D[5][2] = 0;
